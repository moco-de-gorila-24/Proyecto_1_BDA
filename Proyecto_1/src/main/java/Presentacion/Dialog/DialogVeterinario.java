...
import static Dominio.Especialidades.Especialidad.*;
...
public class DialogVeterinario extends JDialog {
    ...
    public void iniciarComponentes() {
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.anchor = GridBagConstraints.NORTHWEST;
        panelContenido.add(new JLabel("Cedula profecional:"), gbc);
        gbc.gridx = 1;
        gbc.weightx = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        gbc.weighty = 0.25;
        ...
        JComboBox<Especialidad> comboEspecialidad = new JComboBox<>(especialidades);
